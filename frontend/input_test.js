...
describe("readGamepadAction", () => {
	...
	it("maps negative X axis to ACTION_LEFT", () => {
		const gp = makeGamepad((g) => (g.axes = [-0.8, 0]));
		assert.equal(FP.readGamepadAction(gp), FP.ACTION_LEFT);
	});
