...
TESTS=(
    ...
    "FuzzCleanName:./internal/covers:ROM filename cleaning"
    "FuzzNameVariants:./internal/covers:ROM name variant generation"
    "FuzzTransformImageURL:./internal/covers:IGDB image URL transformation"
    "FuzzNewIGDBFetcher:./internal/covers:IGDB fetcher construction"
