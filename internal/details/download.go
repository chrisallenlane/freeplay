...
// calls resolve without touching disk. Mirrors saveDetails on the
// negative path: atomic marker write + memoize.
...
func (c *Cache) saveDetails(
	...
	if err := atomicfile.Write(c.detailsPath(console, cleanName), func(w io.Writer) error {
